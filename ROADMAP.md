...
- [x] WorldModel инстансы (машины, двери, граффити, небо-куб) — без полного object runtime
- [x] Текстуры: лог пропусков, опечатка Tile_MIrrow, cubemap не как 2D
- [ ] Sky pass (SkyPointer + SkyCamera), не серая пустота

### 2. Игрок 1:1
- [x] Ходьба, присед, lean, прыжок, фонарик
...
### 3. Объекты и скрипты
- [x] GameStartPoint спавн + ближайшие LightPoint/Fill (не полный object runtime)
...
Порядок работы: не перескакивать фазы. Фаза 1 каркас закрыта, но **полный мир важнее slow-mo**: сначала WorldModel + дыры в текстурах + небо, потом рефлекс.
