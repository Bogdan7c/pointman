...
5. **BlackLight** `0x00517100` — объекты `+0x57==3` и `+0x105==6`, cvar `Light_BlackLight`. Drawer `0x0051bab0` = клон Spot. Тени `0x0051fac0` tech **8**, затем lit `0x0050ffc0` tech **7**. Blend/z как у ламп.
